...
for i in item:
    ...
    temp_df['general_cpi'] = temp_df['general_cpi'].fillna(method='bfill')
    temp_df['foods_cpi'] = temp_df['foods_cpi'].fillna(method='bfill')
    temp_df['national_avg_salary'] = temp_df['national_avg_salary'].fillna(method='bfill')
    temp_df['person_avg_salary'] = temp_df['person_avg_salary'].fillna(method='bfill')
    temp_df['Day_Temperature'] = temp_df['Day_Temperature'].fillna(method='bfill')
    temp_df['Night_Temperature'] = temp_df['Night_Temperature'].fillna(method='bfill')
    temp_df['general_cpi'] = temp_df['general_cpi'].fillna(method='ffill')
    temp_df['foods_cpi'] = temp_df['foods_cpi'].fillna(method='ffill')
    temp_df['national_avg_salary'] = temp_df['national_avg_salary'].fillna(method='ffill')
    temp_df['person_avg_salary'] = temp_df['person_avg_salary'].fillna(method='ffill')
    temp_df['Day_Temperature'] = temp_df['Day_Temperature'].fillna(method='ffill')
    temp_df['Night_Temperature'] = temp_df['Night_Temperature'].fillna(method='ffill')
    arr.append(temp_df)
